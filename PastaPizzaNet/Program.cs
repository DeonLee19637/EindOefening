...
//Dranken
Drank koffie = new Warmedrank(DrankNaam.Koffie);
Drank thee = new Warmedrank(DrankNaam.Thee);
Drank water = new Frisdrank(DrankNaam.Water);
Drank limonade = new Frisdrank(DrankNaam.Limonade);
Drank cola = new Frisdrank(DrankNaam.Cocacola);
//Drank verkeerdeDrank = new Frisdrank(DrankNaam.Koffie);
